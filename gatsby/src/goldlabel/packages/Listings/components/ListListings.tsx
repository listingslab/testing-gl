...
// import {TitleListings} from "../../Listings"


export default function ListListings(props: any) {
  const {frontmatter} = props
  const {bookSlug} = frontmatter
        ...
        <Collapse in={books} timeout="auto" unmountOnExit>
          <List>
            {allBooks.map((item: any, i: number) => {
              ...
              // console.log("itemBookSlug", itemBookSlug)
              if (itemBookSlug === "home") return null
